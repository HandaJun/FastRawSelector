    ...
    public static class Loc
    {
        ...
        private static Dictionary<string, string> BuildKo()
        {
            return new Dictionary<string, string>
            {
                ...
                { "UpdateHint", "GitHub Releases 최신 버전을 확인합니다.\n동의하면 zip을 받아 앱을 종료한 뒤 자동으로 교체·재실행합니다." },
                { "UpdateTitle", "업데이트" },
                { "UpdateAvailable", "새 버전이 있습니다.\n\n현재: {0}\n최신: {1}\n\n지금 다운로드하고 설치할까요?\n(앱이 종료된 뒤 자동으로 다시 실행됩니다)" },
                { "UpdateLatest", "이미 최신 버전입니다.\n({0})" },
                { "UpdateCheckFail", "업데이트 확인에 실패했습니다.\n{0}" },
                { "UpdateDownloading", "새 버전을 다운로드합니다.\n잠시만 기다려 주세요." },
                { "UpdateDownloadFail", "다운로드 또는 설치 준비에 실패했습니다.\n{0}" },
                { "UpdateApplyFail", "업데이트 배치를 시작하지 못했습니다.\n폴더 쓰기 권한을 확인하세요." },
                { "UpdateNoAsset", "Release 에 다운로드할 zip/exe 가 없습니다.\n웹 페이지를 엽니다." },
                { "LastFolder", "최근 폴더: {0}" },
        ...
        private static Dictionary<string, string> BuildJa()
        {
            return new Dictionary<string, string>
            {
                ...
                { "UpdateHint", "GitHub Releases の最新版を確認します。\n同意すると zip を取得し、終了後に自動で差し替え・再起動します。" },
                { "UpdateTitle", "アップデート" },
                { "UpdateAvailable", "新しいバージョンがあります。\n\n現在: {0}\n最新: {1}\n\n今すぐダウンロードしてインストールしますか？\n（アプリ終了後に自動で再起動します）" },
                { "UpdateLatest", "すでに最新バージョンです。\n({0})" },
                { "UpdateCheckFail", "アップデート確認に失敗しました。\n{0}" },
                { "UpdateDownloading", "新しいバージョンをダウンロードします。\nしばらくお待ちください。" },
                { "UpdateDownloadFail", "ダウンロードまたは準備に失敗しました。\n{0}" },
                { "UpdateApplyFail", "更新用バッチを起動できませんでした。\nフォルダの書き込み権限を確認してください。" },
                { "UpdateNoAsset", "Release に zip/exe がありません。\nWeb ページを開きます。" },
        ...
        private static Dictionary<string, string> BuildEn()
        {
            return new Dictionary<string, string>
            {
                ...
                { "UpdateHint", "Checks the latest GitHub Release.\nIf you accept, downloads the zip, exits, then replaces and restarts the app." },
                { "UpdateTitle", "Update" },
                { "UpdateAvailable", "A new version is available.\n\nCurrent: {0}\nLatest: {1}\n\nDownload and install now?\n(The app will restart automatically after exit.)" },
                ...
                { "UpdateDownloadFail", "Download or install prep failed.\n{0}" },
                { "UpdateApplyFail", "Could not start the update script.\nCheck write permission on the install folder." },
                { "UpdateNoAsset", "No zip/exe asset on the Release.\nOpening the web page." },
